...
import (
	...
	"github.com/opensds/multi-cloud/s3/pkg/signature"
)
...
func (h GenerateContextHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	ctx := context.WithValue(r.Context(), RequestContextKey, RequestContext{requestId, bucketInfo, objectInfo, credential})
