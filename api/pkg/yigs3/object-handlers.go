...
import (
	...
	"github.com/opensds/multi-cloud/api/pkg/yigs3/datatype/policy"
	"github.com/opensds/multi-cloud/yigs3/pkg/crypto"
...
func (api ObjectAPIHandlers) errAllowableObjectNotFound(request *http.Request, bucketName string,
	...
	// temporarily comment the code block
	...
	return ErrAccessDenied   /*temporarily add the line*/
}
